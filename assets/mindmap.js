/* mindmap.js - reusable knowledge-map layer for the learn-X-with-phoebe courses.
   ...
   window.MINDMAP_DATA = {
     ...
     centerColor: "#164E63",
     sessions: [
       { label:"Frame & charter", href:"courses/01-...html", color:"#0E7490",
...
(function () {
  ...
  var C_DEEP   = theme("--indigo-deep", "#164E63");   // root fill
  var C_SOFT   = theme("--indigo-soft", "#A5F3FC");   // concept border
  var C_TINT   = theme("--indigo-50", "#ECFEFF");     // concept fill
  var C_INK    = theme("--ink", "#0F1E24");           // concept text
  var C_FAINT  = theme("--faint", "#C6D5DA");         // twig edges
